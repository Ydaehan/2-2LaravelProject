  ...
  <form action="/login" method="post">
    ...
    <div class="flex flex-col border-4 w-login h-login mt-32  bg-slate-100 rounded-3xl">
      ...
      <div class="flex flex-row items-center justify-center mt-4">
        <label for="password" class="col-md-4 col-form-label text-md-right ml-4 text-3xl">{{ __('password')}}</label>
        <div class="col-md-6">
      ...
      <div class="flex flex-row justify-between mt-24">
        <button id="lCancelBtn" type="button" class="border-2 hover:bg-slate-200 rounded-full w-20 hover:font-semibold ">cancel</button>
